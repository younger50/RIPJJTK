...
//
void SET(int portHigh, int portLow){
    if( portHigh==3 && portLow==0 ){ digitalWrite( A0, HIGH); }
    if( portHigh==3 && portLow==1 ){ digitalWrite( A1, HIGH); }
    if( portHigh==3 && portLow==3 ){ digitalWrite( A3, HIGH); }
    if( portHigh==4 && portLow==3 ){ digitalWrite( 3, HIGH); }
    if( portHigh==4 && portLow==4 ){ digitalWrite( 4, HIGH); }
    if( portHigh==4 && portLow==6 ){ digitalWrite( 6, HIGH); }
    if( portHigh==4 && portLow==7 ){ digitalWrite( 7, HIGH); }
}
void CLR(int portHigh, int portLow){
    if( portHigh==3 && portLow==0 ){ digitalWrite( A0, LOW); }
    if( portHigh==3 && portLow==1 ){ digitalWrite( A1, LOW); }
    if( portHigh==3 && portLow==3 ){ digitalWrite( A3, LOW); }
    if( portHigh==4 && portLow==3 ){ digitalWrite( 3, LOW); }
    if( portHigh==4 && portLow==4 ){ digitalWrite( 4, LOW); }
    if( portHigh==4 && portLow==6 ){ digitalWrite( 6, LOW); }
    if( portHigh==4 && portLow==7 ){ digitalWrite( 7, LOW); }
}
...
void positionControl()
{
  ...
  SET(PORTC,3); // for external timing debug
  timer = micros();
  ...
  CLR(PORTC,3); // for external timing debug
}
